...
public class AddressBook {
    ...
    protected static final String PERSON_DATA_PREFIX_PHONE = "p/";
    protected static final String PERSON_DATA_PREFIX_EMAIL = "e/";
    ...
    /*
     * ==============NOTE TO STUDENTS======================================================================
     * Note that the type of the variable below can also be declared as List<Person>, as follows:
     *    private static final List<Person> ALL_PERSONS = new ArrayList<>()
    ...
    private static String executeSortPersons(){
        ...
        ArrayList<Person> toBeDisplayed = (ArrayList<Person>) getAllPersonsInAddressBook().clone();
        toBeDisplayed.sort(personComparator);
