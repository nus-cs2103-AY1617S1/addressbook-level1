...
public class AddressBook {
    ...
    private static void setupGivenFileForStorage(String filePath) {
        ...
        if (!isValidFilePath(filePath)) {
            showToUser(MESSAGE_INVALID_FILE.replace("%1$s", filePath));
            exitProgram();
        }
    ...
    private static void createFileIfMissing(String filePath) {
        ...
        showToUser(MESSAGE_ERROR_MISSING_STORAGE_FILE.replace("%1$s", filePath));
    ...
    private static ArrayList<String> getLinesInFile(String filePath) {
        ...
        try {
            ...
            showToUser(MESSAGE_ERROR_READING_FROM_FILE.replace("%1$s", filePath));
            exitProgram();
        }
        return lines;
    }
    ...
    private static void savePersonsToFile(ArrayList<HashMap<PersonProperty, String>> persons, String filePath) {
        ...
        try {
            ...
            showToUser(MESSAGE_ERROR_WRITING_TO_FILE.replace("%1$s", filePath));
            exitProgram();
        }
    }
    ...
    private static Optional<HashMap<PersonProperty, String>> decodePersonFromString(String encoded) {
        ...
        final HashMap<PersonProperty, String> decodedPerson = createPersonFromData(extractNameFromPersonString(encoded),
