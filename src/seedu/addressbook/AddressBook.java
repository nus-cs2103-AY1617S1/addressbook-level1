...
/*
 * NOTE : ============================================================= This
 * class is written in a procedural fashion (i.e. not Object-Oriented) Yes, it
 * is possible to write non-OO code using an OO language.
 * ====================================================================
 */
...
/*
 * NOTE : ============================================================= This
 * class header comment below is brief because details of how to use this class
...
public class AddressBook {
    ...
    /**
     * We use a HashMap to store details of a single person. The key is an enum PersonProperty 
     * representing NAME, PHONE or EMAIL.
     */
    
    private static enum PersonProperty {NAME, PHONE, EMAIL};
     ...
     * command.
     *
     * @param findPersonCommandArgs full command args string for the find
     *            persons command
    ...
    private static String executeDeletePerson(String commandArgs) {
        ...
        return hasDeletePersonFromAddressBook(targetInModel) ? getMessageForSuccessfulDelete(targetInModel) // success
     ...
     *
     * @param targetInModel the actual person inside the address book (exactPerson
     *            == the person to delete in the full list)
     * @return true if the given person was found and deleted in the model
     */
    private static boolean hasDeletePersonFromAddressBook(HashMap<PersonProperty, String> targetInModel) {
        final boolean isChanged = ALL_PERSONS.remove(targetInModel);
        if (isChanged) {
            savePersonsToFile(getAllPersonsInAddressBook(), storageFilePath);
        }
        return isChanged;
     ...
     *
     * @param decodedPerson String array representing the person (used in internal
     *            data)
     */
    private static boolean isPersonDataValid(HashMap<PersonProperty, String> decodedPerson) {
        return isPersonNameValid(decodedPerson.get(PersonProperty.NAME)) && isPersonPhoneValid(decodedPerson.get(PersonProperty.PHONE))
