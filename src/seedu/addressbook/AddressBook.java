...
public class AddressBook {
	 ...
	 */
	/*
	 * private static void showToUser(String... message) { for (String m :
	...
	private static boolean isPersonDataValid(HashMap<PersonProperty, String> person) {
		return isPersonNameValid(person.get(PersonProperty.NAME)) && isPersonPhoneValid(person.get(PersonProperty.PHONE))
