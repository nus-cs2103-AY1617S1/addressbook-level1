...
public class AddressBook {
    ...
    /**
     * Update:
     * We will use a HashMap with the following keys to store the details of each person.
     * Both keys and values have the String data type.
     */
     ...
     * Update: ALL_PERSONS is now an ArrayList of HashMaps.
     */
...
//        final Optional<String[]> decodeResult = decodePersonFromString(commandArgs);
        ...
        // Update: The original personToAdd is now renamed to personToAddStrArr. personToAdd is now a HashMap<String, String>.
//        String[] personToAdd = decodeResult.get();
        HashMap<String, String> personToAdd = decodeResult.get();
     ...
     * Update: addedPerson is now a HashMap<String, String>.
     *
...
//    private static String getMessageForSuccessfulAddPerson(String[] addedPerson) {
     ...
     * Update: personsFound is now an ArrayList of HashMap<String, String>.
     *
     * @param commandArgs full command args string from the user
     * @return feedback display message for the operation result
     */
...
//        final ArrayList<String[]> personsFound = getPersonsWithNameContainingAnyKeyword(keywords);
     ...
     * Update: personsDisplayed is now an ArrayList of HashMap<String, String>.
     *
...
//    private static String getMessageForPersonsDisplayedSummary(ArrayList<String[]> personsDisplayed) {
     ...
     * Update: Return type is now an ArrayList of HashMap<String, String>.
     *
...
//        Update: Patch needed for delete method
     ...
     * Update: deletedPerson is now a HashMap<String, String>.
     *
...
//    private static String getMessageForSuccessfulDelete(String[] deletedPerson) {
     ...
     * Update: toBeDisplayed is now an ArrayList of HashMap<String, String>.
     *
     * @return feedback display message for the operation result
     */
...
//        ArrayList<String[]> toBeDisplayed = getAllPersonsInAddressBook();
    ...
    */
     ...
     * Update: message is now a HashMap<String, String>.
     */
...
//    private static void showToUser(ArrayList<String[]> persons) {
     ...
     * Update: persons is now an ArrayList of HashMap<String, String>.
     */
...
//        }
     ...
     * Update: person is now a HashMap<String, String>.
     *
...
//        latestPersonListingView = new ArrayList<>(newListing);
    	...
    	// With help from: http://stackoverflow.com/questions/715650/how-to-clone-arraylist-and-also-clone-its-contents
        ArrayList<HashMap<String, String>> clonedListing = new ArrayList<>(newListing.size());
        for (HashMap<String, String> person : newListing) {
        	clonedListing.add((HashMap<String, String>) person.clone());
        }
        latestPersonListingView = clonedListing;
    }
     ...
     * 		   Update: Return type is now a HashMap<String, String>.
     */
...
//    private static void addPersonToAddressBook(String[] person) {
     ...
     * 		  Update: exactPerson is now a HashMap<String, String>.
...
//    private static boolean deletePersonFromAddressBook(String[] exactPerson) {
	private static boolean deletePersonFromAddressBook(HashMap<String, String> exactPerson) {
    	...
    	for (int i = 0; i < ALL_PERSONS.size(); i++) {
    		HashMap<String, String> currentPerson = ALL_PERSONS.get(i);
    		if (exactPerson.get(PERSON_PROPERTY_NAME).equals(currentPerson.get(PERSON_PROPERTY_NAME))) {
    			exactPerson = ALL_PERSONS.get(i);
    			break;
    		}
    	}
    	// Additional code END
     ...
     * 		   Update: Return type is now ArrayList of HashMap<String, String>.
     */
...
//        person[PERSON_DATA_INDEX_EMAIL] = email;
    ...
    /**
     * Encodes a person into a decode-able and readable string representation.
     * Update: person is now a HashMap<String, String>.
     *
...
//    private static String encodePersonToString(String[] person) {
    ...
    /**
     * Encodes list of persons into list of decode-able and readable string representations.
     * Update: person is now a HashMap<String, String> and
     * 		   persons is now an ArrayList of HashMap<String, String>.
     *
