...
public class AddressBook {
    ...
    /**
     * Displays all persons in the address book to the user; in the order of sorted first strings.
     *
     * @return feedback display message for the operation result
     */
    private static String executeListAllPersonsInAddressBook() {
        ...
        Comparator<String[]> cmp = new Comparator<String[]>() {
            ...
            public int compare(String[] self, String[] other) {
                return self[0].toLowerCase().charAt(0) > other[0].toLowerCase().charAt(0) ? 1 : -1;
            }
        };
        
        Collections.sort(toBeDisplayed, cmp);
