...
public class AddressBook {
    ...
    private static final String MESSAGE_SUCCESS_SORT = "The people have been sorted successfully.";
    ...
    private static ArrayList<String[]> getPersonsWithNameContainingAnyKeyword(Collection<String> keywords) {
        ...
        Collection<String> lowerCaseKeywords = new HashSet<>();
    ...
    /**
     * Sort all the people in alphabetic order
     * 
     * @return feedback display message for the operation result
     */
    private static String executeSortRequest() {
		Collections.sort(ALL_PERSONS, createAlphabeticComparator());
		return MESSAGE_SUCCESS_SORT;
	}
    
    /**
     * Create a new comparator based on alphabetic order of names
     * @return
     */
    private static Comparator<String[]> createAlphabeticComparator() {
