...
public class AddressBook {
     ...
     * ====================================================================
     */
    private static final String MESSAGE_ADDED = "Not very new person added: %1$s, Phone: %2$s, Email: %3$s";
    private static final String MESSAGE_EDITED = "Not very new person edited: %1$s, Phone: %2$s, Email: %3$s";
     ...
     */
    private static ArrayList<HashMap<PersonProperty, String>> latestPersonListingView 
    ...
    /**
     * Edits a person (specified by the command args) entry in the address book.
    ...
    private static String executeEditPerson(String commandArgs) {
        ...
        String nameOfPersonToEdit = getNameFromPerson(personToEdit);
        
        // check through the address book for the person's name
        for (HashMap<PersonProperty, String> person : getAllPersonsInAddressBook()){
        	// if found, replace person's properties with user supplied changes
        	if (person.get(PersonProperty.NAME).equals(nameOfPersonToEdit)){
        		person.replace(PersonProperty.PHONE, getPhoneFromPerson(personToEdit));
        		person.replace(PersonProperty.EMAIL, getEmailFromPerson(personToEdit));
    ...
    private static Set<String> extractKeywordsFromFindPersonArgs(String findPersonCommandArgs) {
        return new HashSet<>(splitByWhitespace(
        		findPersonCommandArgs.trim().toUpperCase()));
    }
    ...
    private static ArrayList<HashMap<PersonProperty, String>> getPersonsWithNameContainingAnyKeyword(
        ...
        for (HashMap<PersonProperty, String> person : getAllPersonsInAddressBook()) {
            final Set<String> wordsInName = new HashSet<>(splitByWhitespace(
            		getNameFromPerson(person).toUpperCase()));
    ...
    */
    ...
    private static void showToUser(String m1, String m2, String m3, String m4) {
        showToUser(m1, m2, m3);
        showToUser(m4);
    }
