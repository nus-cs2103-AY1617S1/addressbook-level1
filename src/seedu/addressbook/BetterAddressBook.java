...
public class BetterAddressBook {
     ...
     */
    private static final String LINE_SPEPARATOR = System.lineSeparator() + LINE_PREFIX;
    ...
    private static final String MESSAGE_INVALID_COMMAND_FORMAT = "Invalid command format: %1$s " + LINE_SPEPARATOR + "%2$s";
    ...
    private static final String MESSAGE_INVALID_PROGRAM_ARGS = "Too many parameters! Correct program argument format:"
                                                            + LINE_SPEPARATOR + "\tjava AddressBook"
                                                            + LINE_SPEPARATOR + "\tjava AddressBook [custom storage file path]";
    ...
    private static boolean isDisplayIndexValidForLastPersonListingView(int index) {
    	...
    	int lowerBound = DISPLAYED_INDEX_OFFSET;
    	int upperBound = getLatestPersonListingView().size() + DISPLAYED_INDEX_OFFSET;
    ...
    */
    ...
    private static String getUsageInfoForAllCommands() {
        return getUsageInfoForAddCommand() + LINE_SPEPARATOR
                + getUsageInfoForFindCommand() + LINE_SPEPARATOR
                + getUsageInfoForViewCommand() + LINE_SPEPARATOR
                + getUsageInfoForDeleteCommand() + LINE_SPEPARATOR
                + getUsageInfoForClearCommand() + LINE_SPEPARATOR
                + getUsageInfoForExitCommand() + LINE_SPEPARATOR
    ...
    private static String getUsageInfoForAddCommand() {
        return String.format(MESSAGE_COMMAND_HELP, COMMAND_ADD_WORD, COMMAND_ADD_DESC) + LINE_SPEPARATOR
                + String.format(MESSAGE_COMMAND_HELP_PARAMETERS, COMMAND_ADD_PARAMETERS) + LINE_SPEPARATOR
                + String.format(MESSAGE_COMMAND_HELP_EXAMPLE, COMMAND_ADD_EXAMPLE) + LINE_SPEPARATOR;
    }
    ...
    private static String getUsageInfoForFindCommand() {
        return String.format(MESSAGE_COMMAND_HELP, COMMAND_FIND_WORD, COMMAND_FIND_DESC) + LINE_SPEPARATOR
                + String.format(MESSAGE_COMMAND_HELP_PARAMETERS, COMMAND_FIND_PARAMETERS) + LINE_SPEPARATOR
                + String.format(MESSAGE_COMMAND_HELP_EXAMPLE, COMMAND_FIND_EXAMPLE) + LINE_SPEPARATOR;
    }
    ...
    private static String getUsageInfoForDeleteCommand() {
        return String.format(MESSAGE_COMMAND_HELP, COMMAND_DELETE_WORD, COMMAND_DELETE_DESC) + LINE_SPEPARATOR
                + String.format(MESSAGE_COMMAND_HELP_PARAMETERS, COMMAND_DELETE_PARAMETER) + LINE_SPEPARATOR
                + String.format(MESSAGE_COMMAND_HELP_EXAMPLE, COMMAND_DELETE_EXAMPLE) + LINE_SPEPARATOR;
    }
    ...
    private static String getUsageInfoForClearCommand() {
        return String.format(MESSAGE_COMMAND_HELP, COMMAND_CLEAR_WORD, COMMAND_CLEAR_DESC) + LINE_SPEPARATOR
                + String.format(MESSAGE_COMMAND_HELP_EXAMPLE, COMMAND_CLEAR_EXAMPLE) + LINE_SPEPARATOR;
    }
    ...
    private static String getUsageInfoForViewCommand() {
        return String.format(MESSAGE_COMMAND_HELP, COMMAND_LIST_WORD, COMMAND_LIST_DESC) + LINE_SPEPARATOR
                + String.format(MESSAGE_COMMAND_HELP_EXAMPLE, COMMAND_LIST_EXAMPLE) + LINE_SPEPARATOR;
    }
